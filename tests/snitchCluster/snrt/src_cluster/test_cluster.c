...
int32_t testReturn(void *args) {
    ...
    if (snrt_is_dm_core()) {
        ...
        printf("L1 Allocator V2 @ %p:\n", snrt_l1_allocator_v2());
        printf("  base @ %p = %#x\n", &snrt_l1_allocator_v2()->base, snrt_l1_allocator_v2()->base);
        printf("  end  @ %p = %#x\n", &snrt_l1_allocator_v2()->end, snrt_l1_allocator_v2()->end);
        printf("  next @ %p = %#x\n", &snrt_l1_allocator_v2()->next, snrt_l1_allocator_v2()->next);
