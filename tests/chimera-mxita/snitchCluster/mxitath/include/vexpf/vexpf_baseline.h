...
SNRT_CLUSTER_L1_ZERO(static double *a_buffer_0);
SNRT_CLUSTER_L1_ZERO(static double *a_buffer_1);
SNRT_CLUSTER_L1_ZERO(static double *b_buffer_0);
SNRT_CLUSTER_L1_ZERO(static double *b_buffer_1);
...
static inline void vexpf_baseline(double *a, double *b) {
    ...
    a_buffer_0 = ALLOCATE_BUFFER(double, BATCH_SIZE);
    a_buffer_1 = ALLOCATE_BUFFER(double, BATCH_SIZE);
    b_buffer_0 = ALLOCATE_BUFFER(double, BATCH_SIZE);
    b_buffer_1 = ALLOCATE_BUFFER(double, BATCH_SIZE);

    a_buffers[0] = a_buffer_0;
    a_buffers[1] = a_buffer_1;
    b_buffers[0] = b_buffer_0;
    b_buffers[1] = b_buffer_1;
