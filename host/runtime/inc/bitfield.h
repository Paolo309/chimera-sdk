...
inline uint32_t bitfield_field32_read(uint32_t bitfield, bitfield_field32_t field) {
 ...
 */
BITFIELD_WARN_UNUSED_RESULT
inline uint32_t bitfield_field32_write(uint32_t bitfield, bitfield_field32_t field,
                                       uint32_t value) {
 ...
 */
BITFIELD_WARN_UNUSED_RESULT
inline bitfield_field32_t bitfield_bit32_to_field32(bitfield_bit32_index_t bit_index) {
 ...
 */
BITFIELD_WARN_UNUSED_RESULT
inline bool bitfield_bit32_read(uint32_t bitfield, bitfield_bit32_index_t bit_index) {
 ...
 */
BITFIELD_WARN_UNUSED_RESULT
inline uint32_t bitfield_bit32_write(uint32_t bitfield, bitfield_bit32_index_t bit_index,
                                     bool value) {
