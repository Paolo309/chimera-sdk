...
#define NUM_CLUSTER_CORES CLUSTER_0_NUMCORES
...
static const uint8_t _chimera_numCores[] = {CLUSTER_0_NUMCORES};
static const uint8_t _chimera_hartBase[] = {CLUSTER_0_HART_BASE};

static const uint32_t _chimera_clusterBase[] = {CLUSTER_0_BASE};

#define _chimera_numClusters 1
